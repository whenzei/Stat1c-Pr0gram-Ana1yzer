...
TEST_CLASS(TestNextTable) {
  ...
  TEST_METHOD(TestIsNextRelationship) {
    ...
    next_table.InsertNext(kProcName1, kStmtNumInt1, kStmtNumInt2);
    next_table.InsertNext(kProcName1, kStmtNumInt2, kStmtNumInt3);
    next_table.InsertNext(kProcName1, kStmtNumInt2, kStmtNumInt4);
