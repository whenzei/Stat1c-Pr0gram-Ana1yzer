...
For each suchthat types, the first and second parameters can only accept a
certain type of PqlDeclarationEntity For example, Follows(x, y), x can either be
a kStmt, kRead, kPrint, ..., kUnderscore
*/
...
const EntitySet parent_first = {
    PqlDeclarationEntity::kStmt,    PqlDeclarationEntity::kWhile,
    PqlDeclarationEntity::kIf,      PqlDeclarationEntity::kProgline,
    PqlDeclarationEntity::kInteger, PqlDeclarationEntity::kUnderscore};
...
const EntitySet uses_s_first = {
    PqlDeclarationEntity::kStmt,     PqlDeclarationEntity::kPrint,
    PqlDeclarationEntity::kCall,     PqlDeclarationEntity::kWhile,
    PqlDeclarationEntity::kIf,       PqlDeclarationEntity::kAssign,
    PqlDeclarationEntity::kProgline, PqlDeclarationEntity::kInteger};
const EntitySet uses_s_second = {PqlDeclarationEntity::kVariable,
                                 PqlDeclarationEntity::kIdent,
                                 PqlDeclarationEntity::kUnderscore};

// UsesP
const EntitySet uses_p_first = {PqlDeclarationEntity::kProcedure,
                                PqlDeclarationEntity::kIdent};
const EntitySet uses_p_second = {PqlDeclarationEntity::kVariable,
                                 PqlDeclarationEntity::kIdent,
                                 PqlDeclarationEntity::kUnderscore};
...
const EntitySet modifies_s_first = {
    ...
    PqlDeclarationEntity::kIf,       PqlDeclarationEntity::kAssign,
    PqlDeclarationEntity::kProgline, PqlDeclarationEntity::kInteger};
const EntitySet modifies_s_second = {PqlDeclarationEntity::kVariable,
                                     PqlDeclarationEntity::kIdent,
                                     PqlDeclarationEntity::kUnderscore};

// ModifiesP
const EntitySet modifies_p_first = {PqlDeclarationEntity::kProcedure,
                                    PqlDeclarationEntity::kIdent};
const EntitySet modifies_p_second = {PqlDeclarationEntity::kVariable,
                                     PqlDeclarationEntity::kIdent,
                                     PqlDeclarationEntity::kUnderscore};

// Calls
const EntitySet calls_first = {PqlDeclarationEntity::kProcedure,
                               PqlDeclarationEntity::kIdent,
                               PqlDeclarationEntity::kUnderscore};
const EntitySet calls_second = {PqlDeclarationEntity::kProcedure,
                                PqlDeclarationEntity::kIdent,
                                PqlDeclarationEntity::kUnderscore};

// CallsT
const EntitySet calls_t_first = {PqlDeclarationEntity::kProcedure,
                                 PqlDeclarationEntity::kIdent,
                                 PqlDeclarationEntity::kUnderscore};
const EntitySet calls_t_second = {PqlDeclarationEntity::kProcedure,
                                  PqlDeclarationEntity::kIdent,
                                  PqlDeclarationEntity::kUnderscore};
...
const SuchthatTable suchthat_table = {
    ...
    {PqlSuchthatType::kFollowsT,
     std::make_pair(follows_t_first, follows_t_second)},
    {PqlSuchthatType::kParent, std::make_pair(parent_first, parent_second)},
    {PqlSuchthatType::kParentT,
     std::make_pair(parent_t_first, parent_t_second)},
    ...
    {PqlSuchthatType::kModifiesS,
     std::make_pair(modifies_s_first, modifies_s_second)},
    {PqlSuchthatType::kModifiesP,
     std::make_pair(modifies_p_first, modifies_p_second)},
...
For each pattern types, the first parameters can only accept a certain type of
PqlDeclarationEntity For example, Follows(x, y), x can either be a kStmt, kRead,
kPrint, ..., kUnderscore
*/

// Assign
const EntitySet pattern_assign = {PqlDeclarationEntity::kVariable,
                                  PqlDeclarationEntity::kUnderscore,
                                  PqlDeclarationEntity::kIdent};

// While
const EntitySet pattern_while = {
    PqlDeclarationEntity::kVariable, PqlDeclarationEntity::kConstant,
    PqlDeclarationEntity::kUnderscore, PqlDeclarationEntity::kIdent};
...
/*
SELECT WITH CLAUSE
The first parameters can only be compatible to a certain type in the second
parameter For example, a1.stmt# = c.value is valid
*/

const EntitySet number = {
    PqlDeclarationEntity::kProgline, PqlDeclarationEntity::kStmt,
    PqlDeclarationEntity::kRead,     PqlDeclarationEntity::kPrint,
    PqlDeclarationEntity::kWhile,    PqlDeclarationEntity::kIf,
    PqlDeclarationEntity::kAssign,   PqlDeclarationEntity::kConstant,
