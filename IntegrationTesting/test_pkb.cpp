...
TEST_CLASS(TestPKB) {
 ...
 public:
  ...
  TEST_METHOD(TestInsertAssignStmt) {
    PKB pkb;
    bool result1 = pkb.InsertAssignStmt(
  ...
  TEST_METHOD(TestInsertWhileStmt) {
    PKB pkb;
    bool result = pkb.InsertWhileStmt(
  ...
  TEST_METHOD(TestInsertIfStmt) {
    ...
    bool result = pkb.InsertIfStmt(&IfStmtData(kStmtNumInt1, kStmtListIndex1,
                                               kStmtListIndex2, kStmtListIndex3,
                                               kVarNameSet1, kConstValueSet1));
    Assert::IsTrue(result);
  }
  ...
  TEST_METHOD(TestInsertReadStmt) {
    PKB pkb;
    bool result = pkb.InsertReadStmt(
        &ReadStmtData(kStmtNumInt1, kStmtListIndex1, kVarName1));
    Assert::IsTrue(result);
  }
  ...
  TEST_METHOD(TestInsertPrintStmt) {
    PKB pkb;
    bool result = pkb.InsertPrintStmt(
  ...
  TEST_METHOD(TestGetModifiedVarS) {
    PKB pkb;
    pkb.InsertAssignStmt(&AssignStmtData(kStmtNumInt2, kStmtListIndex2,
                                         kVarName1, kVarNameSet2,
                                         kConstValueSet1, kTokenList));
    pkb.InsertAssignStmt(&AssignStmtData(kStmtNumInt4, kStmtListIndex3,
                                         kVarName2, kVarNameSet1,
                                         kConstValueSet1, kTokenList));
  ...
  TEST_METHOD(TestGetModifiedVarP) {
    ...
    pkb.InsertAssignStmt(&AssignStmtData(kStmtNumInt4, kStmtListIndex2,
                                         kVarName2, kVarNameSet2,
                                         kConstValueSet1, kTokenList));
  ...
  TEST_METHOD(TestGetAllUsedVar) {
    ...
    pkb.InsertPrintStmt(
        &PrintStmtData(kStmtNumInt2, kStmtListIndex1, kVarName1));
  ...
  TEST_METHOD(TestGetUsedVarS) {
    ...
    pkb.InsertReadStmt(&ReadStmtData(kStmtNumInt1, kStmtListIndex1, kVarName1));
    pkb.InsertWhileStmt(&WhileStmtData(kStmtNumInt2, kStmtListIndex1,
                                       kStmtListIndex2, kVarNameSet2,
                                       kConstValueSet1));
    pkb.InsertAssignStmt(&AssignStmtData(kStmtNumInt3, kStmtListIndex2,
                                         kVarName1, kVarNameSet1,
                                         kConstValueSet1, kTokenList));
